  ...
  return (
    <div className="mainPageMobile">
      ...
      {data.length == 0 ? (
            ...
            data.map((ele) => (
              <Paper className="historyCardMobile" elevation={16}>
                <div className="sNoMobile">{data.indexOf(ele) + 1}</div>
                <div className="urlsMobile">
                  <div>{ele.longUrl}</div>
                  <a
                    onClick={() => urlHistory()}
                    href={ele.shortUrl}
                ...
                <div className="clicksMobile">{ele.click}</div>
              </Paper>
            ))
          )}
